...
const PROTOCOL_RULES = [
  {
    ...
    color: "#3b82f6",
    content:
      'כל פעולה בחשבון המסחר (הפעלה, עצירה או שינוי כמויות) תבוצע אך ורק על פי החלטה כתובה ומתועדת מראש בכרטיסיית "יומן החלטות". אין לקבל החלטות אסטרטגיות או לבצע שינויים בפרמטרים בזמן שהמסחר חי; כל שינוי מחייב "ישיבת מנהל" ותיעוד התאריך והרציונל לפני הביצוע בפועל.',
  },
  {
    number: 2,
    title: 'וטו מוחלט: איסור נגיעה ידנית! (HANDS-OFF)',
    icon: HandMetal,
    color: "#ef4444",
    content:
      'חל איסור מוחלט, סופי וגורף על ביצוע פעולות קנייה או מכירה ידניות מכל סוג, ללא קשר למטרה, לנסיבות או ל"הזדמנויות" בשוק. יוצא מן הכלל מקרים בהם האסטרטגיה החמיצה כניסה והמחיר הנוכחי אטרקטיבי יותר. אין להקליק ולסחור ידנית בשום מצב.',
  },
  {
    number: 3,
    ...
    color: "#f59e0b",
    content:
      'התערבות ידנית במערכת מותרת אך ורק במקרה של שגיאה טכנית המחייבת פעולה מיידית להחזרת החשבון למצב הנכון (כגון פוזיציה שצריכה הייתה להיסגר ולא נסגרה, או נתק ב-API). מטרת ההתערבות היא בלעדית: יישור קו עם מצב האסטרטגיה הנדרש או הבאת החשבון למצב "נקי" (Flat).',
  },
  {
    number: 4,
    ...
    color: "#a855f7",
    content:
      'כל שגיאה טכנית שהצריכה התערבות ידנית מחייבת רישום מיידי בכרטיסיית "תיעוד שגיאות", כולל פירוט המקרה והפעולה שננקטה. חובה לבצע תחקיר עומק ולתקן את הכשל בבסיסו (בקוד או בתשתית המערכת) בהקדם האפשרי, במטרה למנוע את הישנות התקלה באופן מוחלט.',
  },
];
